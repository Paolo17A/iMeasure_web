...
class _ViewServicesScreenState extends ConsumerState<ViewServicesScreen> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      try {
        ...
        ref
            ...
            .setGalleryDocs(await getAllServiceGalleryDocs());
        ref.read(loadingProvider).toggleLoading(false);
      } catch (error) {
        ref.read(loadingProvider).toggleLoading(false);
        scaffoldMessenger.showSnackBar(SnackBar(
            content: Text('Error getting all service entries: $error')));
      }
    });
  }
                  ...
                  child: Column(
                    children: [
                      ...
                      horizontal5Percent(context,
                          child: Column(
                            children: [_servicesHeader(), _serviceEntries()],
                          )),
                    ],
                  ),
                ),
  ...
  Widget _servicesHeader() {
    return all20Pix(
        child: Row(children: [
      quicksandWhiteBold('Services: ', fontSize: 28),
      Gap(4),
  ...
  Widget _serviceEntries() {
    return Center(
        child: ref.read(galleryProvider).galleryDocs.isNotEmpty
            ...
            : quicksandWhiteBold('No service entries added yet'));
  }
              ...
              all4Pix(
                child: editEntryButton(context,
                    ...
                    onPress: () => GoRouter.of(context)
                            .goNamed(GoRoutes.editService, pathParameters: {
                ...
                child: deleteEntryButton(context,
                    ...
                    onPress: () => displayDeleteEntryDialog(context,
                        ...
                        deleteEntry: () => deleteGalleryDoc(context, ref,
                            ...
                            refreshGalleryFuture: getAllServiceGalleryDocs()))),
              ),
            ],
          )
        ],
