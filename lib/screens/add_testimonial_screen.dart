...
class AddTestimonialScreen extends ConsumerStatefulWidget {
  const AddTestimonialScreen({super.key});

  @override
  ConsumerState<AddTestimonialScreen> createState() =>
      _AddTestimonialScreenState();
}

class _AddTestimonialScreenState extends ConsumerState<AddTestimonialScreen> {
                      ...
                      children: [
                        ...
                        submitButton(context,
                            ...
                            onPress: () => addGalleryDoc(context, ref,
                                galleryType: GalleryTypes.testimonial,
  ...
  Widget _newServiceHeaderWidget() {
    return quicksandWhiteBold('NEW TESTIMONIAL',
