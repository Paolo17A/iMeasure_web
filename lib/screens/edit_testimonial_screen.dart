...
class EditTestimonialScreen extends ConsumerStatefulWidget {
  final String galleryID;
  const EditTestimonialScreen({super.key, required this.galleryID});

  @override
  ConsumerState<EditTestimonialScreen> createState() =>
      _EditTestimonialScreenState();
}

class _EditTestimonialScreenState extends ConsumerState<EditTestimonialScreen> {
  ...
  Widget _newServiceHeaderWidget() {
    return quicksandWhiteBold('EDIT TESTIMONIAL',
